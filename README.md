A cheeky robot designed using Selenium (I know Selenium is used for automating tests, not ROBOTS!). Have it running in the background while you work on something 
